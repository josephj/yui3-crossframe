...
}, '3.3.0pr3' ,{requires:['get','features']});
...
YUI.add('yui', function(Y){}, '3.3.0pr3' ,{use:['yui-base','get','features','rls','intl-base','yui-log','yui-later','yui-throttle']});
